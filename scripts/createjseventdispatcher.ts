import {Event} from 'please update this location. Example: utility/createjsevent';
export class EventDispatcher {

    public _listeners:any = null;

    public _captureListeners:any = null;
    ...
    public dispatchEvent(eventObj, target): boolean {
        if (typeof eventObj == "string") {
            ...
            eventObj = new Event(eventObj, false, false);
    ...
    hasEventListener(type: string): boolean {
        let listeners:any = this._listeners, captureListeners = this._captureListeners;
	 ...
	 * @protected
	 **/
    _dispatchEvent(eventObj: Object, eventPhase: Object): boolean;
    _dispatchEvent(eventObj: String, eventPhase: Object): boolean;
    _dispatchEvent(eventObj: Event, eventphase: Object): boolean;
